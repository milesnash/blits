...
import { RendererMainSettings } from "@lightningjs/renderer";
...
export type ComponentContext<
  ...
  M extends Methods = {},
  C extends Computed = {},
> = ThisType<Readonly<InferProps<P>> & S & M & ComputedProps<C> & ChildComponentBase>;
...
export type ApplicationContext<
  ...
  M extends Methods = {},
  C extends Computed = {},
> = ThisType<Readonly<InferProps<P>> & S & M & ComputedProps<C> & ApplicationBase>;
...
export type RouteTransitionFunction = (
  previousRoute: Route,
  currentRoute: Route,
) => RequireAtLeastOne<RouteTransition>;
...
type ComputedProps<T extends Record<string, () => any> = Record<string, () => any>> = {
...
export interface Blits {
  ...
  Application<
    ...
    W extends Watch,
  >(
    config: ApplicationConfig<P, S, M, C, W>,
  ): ComponentFactory;
  /**
   * Blits Component
